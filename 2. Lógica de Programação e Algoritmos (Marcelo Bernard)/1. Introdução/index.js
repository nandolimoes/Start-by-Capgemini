// Aula 1
// Lógica de programação e algoritmo (Prof. Marcelo Bernard)
// Computador = Todo dispositivo que tem entrada, processamento e saída
// Ex: microondas, freezer, carro, website, computador, videogame
// Ciência da computação aborda muito mais coisas do que lógica e algoritmos, transforma dados em informação
// Está cada vez mais fácil programar, a 20 anos precisaria de 50 línguas enquanto hoje 2 linhas 
// Com Arduino com 10 linhas faz um robô girar 360º
// Não há mais sucesso em qualquer área sem tecnologia, pois é base para todas as outras.

// Aula 2
// Lógica de programação = Algoritmos
// Algoritmos = receita
// Ex: como fazer um Nescau
// Vários parâmetros alteram como o programa funciona
...
// Área de trabalho, Linux, Windows, microondas, robôs, celulares (Java)
// Recomendação do professor C# (Proway), mesmas ideias do Java mas focada para a plataforma Windows (mais facilidade para programar no Windows)
// SP tem demanda por Cobol (linguagem de 1960), para aplicações comerciais. Os bancos ainda utilizam este sistema.
// C e C++ originaram o Java e o C#, utilizada para criar o Windows.
